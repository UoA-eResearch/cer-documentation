...
If you prefer video tutorials, you can refer to [Nectar On-board Tutorial Videos](./ntr-onboard.md)
...
![useful image](/cer-documentation/assets/ntr-win-step1-image.png){:width="60%"}
...
![useful image](/cer-documentation/assets/ntr-win-step2-az.png){:width="60%"}
...
![step3](/cer-documentation/assets/step3-init.png){:width="60%"}
...
![step4](/cer-documentation/assets/step4-login.png){:width="60%"}
...
![step5](/cer-documentation/assets/step5-ip.png){:width="60%"}
...
![step5](/cer-documentation/assets/step6-rdp.png){:width="50%"}
