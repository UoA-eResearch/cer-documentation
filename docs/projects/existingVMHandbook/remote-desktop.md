...
![useful image](/cer-documentation/assets/screenshot1.png){:width="50%"}
...
![useful image](/cer-documentation/assets/rdp-screenshot3.png){:width="50%"}

On Mac, Add local resources follow the screen shot below:

![useful image](/cer-documentation/assets/rdp-screenshot4.png){:width="50%"}
...
![useful image](/cer-documentation/assets/rdp-screenshot5.png){:width="50%"}
